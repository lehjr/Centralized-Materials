    ...
    public static class RegistryEvents extends Block {
        ...
        public static void registerItems(RegistryEvent.Register<Item> event) {
            event.getRegistry().registerAll(
                    ...
                    ItemList.diamond_dust = (new Item((new Item.Properties()).group(ItemTabs.tabCentralixedMaterials))).setRegistryName(location("electrum_dust")),
                    ItemList.electrum_dust = (new Item((new Item.Properties()).group(ItemTabs.tabCentralixedMaterials))).setRegistryName(location("diamond_dust")),
